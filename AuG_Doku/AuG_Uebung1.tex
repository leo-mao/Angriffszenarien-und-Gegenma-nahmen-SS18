...
\begin{document}
    ...
    \section{WPA/WPA2}
    	\begin{exercise}
    		...
    		\begin{answer}
    			Authernticator werden bei dem Zugangspunkt von WLAN eingerichtet, um die Nachrichten eines EAP-Protokolls zwischen Supplicant und Authentication Server zu leiten.
    		...
    		Bei Key Reinstallation Angrff werden 4-Wege-Handshake Phase gestört und damit der selbe Schlüssel mehrmals verwendet wird.
