...
\begin{document}
    ...
    \section{WEP}
		...
		Ein Angreifer kann auch gezielt die Bits der IP-Zieladresse so abändern, dass das Paket in ein vom Angreifer kontrolliertes Netzwerk umgeleitet wird. Er kann dann die andere Headerfeld so abänderen, dass die Prüfsnumme gleich beleibt.
		\end{answer}
